        ...
        <section id="projects" className="p-8 bg-[#022B54] text-[#EAEAEA]">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <Link to="/StationOfTheDead"
                    ...
                    <p className="text-sm">Station of the Dead is een game die is ontwikkeld in een team van 4 met Unreal Engine 5 tijdens ons eerste studiejaar.</p>
                </Link>
                ...
                <Link to="/SignTrail"
                    ...
                    <p className="text-sm">Onze gebaren game hebben we gemaakt voor het keuzevak gebaren taal om het leren leuker en interactiever te maken.</p>
                </Link>
